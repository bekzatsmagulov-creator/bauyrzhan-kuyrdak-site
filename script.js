...
document.addEventListener('DOMContentLoaded', () => {
    const cards = document.querySelectorAll('.menu-item, .kuyrdak-card, .stat');
    cards.forEach(card => {
...
if (orderForm) {
    orderForm.addEventListener('submit', function(e) {
        ...
        const kuyrdakType = this.querySelector('select').value;
        const specialRequests = this.querySelector('textarea').value;
        
        // Простая валидация
        if (!name || !phone || !kuyrdakType) {
            showNotification('Барлық өрістерді толтырыңыз', 'error');
            return;
        }
        
        // Имитация отправки заказа
        showNotification('Тапсырысыңыз қабылданды! Бауыржан сізбен хабарласады.', 'success');
        this.reset();
    });
}
